...
ALTER TABLE "region_US" ADD CONSTRAINT "fk_region_US_region_2" FOREIGN KEY("region_2")
REFERENCES "region_2" ("region_2");

ALTER TABLE "region_2" ADD CONSTRAINT "fk_region_2_region_2" FOREIGN KEY("region_2")
REFERENCES "wine_data" ("region_2");
